...
<head>
    ...
    <title>Hall 1</title>
    <link rel="icon" href="images/profile_image.png" type="image/png"> <!-- Define um ícone para a página que aparecerá na aba do navegador -->
    <link rel="stylesheet" href="https://maxcdn.bootstrapcdn.com/bootstrap/4.0.0/css/bootstrap.min.css"> <!-- Carrega a folha de estilos do Bootstrap para o design da página -->
</head>
<body>
    <div class="container mt-5"> <!-- Cria um container com margem superior de 5 para centralizar o conteúdo -->
        <h1 class="text-center mb-4">Voo Decolando - Hall 1</h1> <!-- Título da página centralizado com margem inferior de 4 -->
        ...
        <div class="table-responsive"> <!-- Torna a tabela responsiva (adaptável a diferentes tamanhos de tela) -->
            <table class="table table-bordered table-striped"> <!-- Cria uma tabela com bordas e linhas alternadas coloridas -->
                ...
                <tbody>
                    <%
                    // Recupera a lista de voos de decolagem do atributo "flightsTakingOff" da requisição
                    ...
                    if (lista != null && !lista.isEmpty()) { // Verifica se a lista de voos não está vazia
                        for (FlightData f : lista) { // Itera sobre cada voo na lista
                            ...
                            // Se o estado do voo for "TakingOff", substitui por "Decolando" para exibição em português
    ...
    <!-- Scripts necessários para o funcionamento do Bootstrap e outras funcionalidades -->
