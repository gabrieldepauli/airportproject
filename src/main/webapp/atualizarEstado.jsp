...
<body>
    <div class="container mt-5">
        <h1 class="text-center mb-4">Atualizar Estado do Voo</h1>
        <hr>
        ...
        <div class="table-responsive">
            <table class="table table-bordered table-striped">
                ...
                <tbody>
                    <%
                    // Obtém a lista de voos passada pelo controlador
                    ...
                    if (lista != null && !lista.isEmpty()) {
                        for (FlightData f : lista) {
                            ...
                            // Traduz o nome do estado para português
                            ...
                            } else if ("Tookof".equals(stateInPortuguese)) {
                    ...
                    <tr>
                        ...
                        <td class="text-center">
                            <form action="updateVoo.do" method="post">
                                <input type="hidden" name="numeroVoo" value="<%= f.getFlightNumber() %>">
                                <input type="hidden" name="action" value="updateFlightState">
        ...
        <div class="text-center mt-4">
            <a href="admin.jsp" class="btn btn-secondary">Voltar</a>
        </div>
    </div>
